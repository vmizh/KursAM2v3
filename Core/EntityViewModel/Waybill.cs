...
namespace Core.EntityViewModel
{
    ...
    public class Waybill : SD_24ViewModel, IDocument<Waybill>
    {
        ...
        public Waybill(SD_24 entity) : base(entity)
        {
            ...
            if (entity != null)
            {
                Schet = new InvoiceClient(entity.SD_84);
        ...
        public InvoiceClient Schet
        {
            get => mySchet;
            set
            {
                if (mySchet != null && mySchet.Equals(value)) return;
                mySchet = value;
                RaisePropertyChanged();
            }
        }
    ...
    public class Waybill_FluentAPI : DataAnnotationForFluentApiBase, IMetadataProvider<Waybill>
    {
            ...
            MetadataBuilder<Waybill> builder)
        {
            ...
            builder.Property(x => x.InvoiceClient).NotAutoGenerated();
            ...
            builder.Property(x => x.Schet).AutoGenerated().DisplayName("Счет");
            ...
            builder.Property(x => x.Receiver).AutoGenerated()
                .DisplayName("№");
        }
    }
}