...
namespace Core.EntityViewModel
{
    ...
    public class SD_251ViewModel : RSViewModelBase, IEntity<SD_251>
    {
        #region Fields
    ...
    {
        public static void BuildMetadata(MetadataBuilder<SD_251ViewModel> builder)
        {
