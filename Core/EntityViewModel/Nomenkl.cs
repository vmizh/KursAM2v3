...
namespace Core.EntityViewModel
{
    ...
    public class Nomenkl : RSViewModelBase, IEntity<SD_83>, ICheckViewModel
    {
        ...
        public static decimal Quantity([NotNull] Warehouse warehouse, [NotNull] Nomenkl nom, DateTime date)
        {
        ...
        public static decimal Price([NotNull] Nomenkl nom, DateTime date)
        {
        ...
        public static decimal PriceWithOutNaklad([NotNull] Nomenkl nom, DateTime date)
        {
            return PriceWithOutNaklad(nom.DocCode, date);
        }

        public static decimal QuantityAll([NotNull] Nomenkl nom, DateTime date)
        {
