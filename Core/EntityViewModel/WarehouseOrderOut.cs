...
namespace Core.EntityViewModel
{
    ...
    public class WarehouseOrderOut : SD_24ViewModel
    {
        ...
        public WarehouseOrderOut(SD_24 entity) : base(entity)
        {
            ...
            if (data != null && data.Count != 0)
                foreach (var item in data)
                    Rows.Add(new WarehouseOrderOutRow(item) {Parent = this});
        ...
        {
            return $"Расходный складской ордер №{DD_IN_NUM}/{DD_EXT_NUM} от {DD_DATE} склад:{WarehouseOut}";
        }
    }
        ...
        IMetadataProvider<WarehouseOrderOut>
    {
            ...
            MetadataBuilder<WarehouseOrderOut> builder)
        {
            ...
            builder.Property(_ => _.WarehouseIn).NotAutoGenerated();
