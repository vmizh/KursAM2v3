...
namespace Core.EntityViewModel
{
        ...
        IMetadataProvider<BankCurrencyChangeViewModel>
    {
            ...
            MetadataBuilder<BankCurrencyChangeViewModel> builder)
        {
            ...
            builder.Property(_ => _.CurrencyFrom).AutoGenerated().DisplayName("Валюта отправителя").ReadOnly();
            builder.Property(_ => _.SummaFrom).AutoGenerated().DisplayName("Сумма отправителя").DisplayFormatString("n2");
            ...
            builder.Property(_ => _.CurrencyTo).AutoGenerated().DisplayName("Валюта получателя").ReadOnly();
            ...
            builder.DataFormLayout()
                ...
                .GroupBox("Банк получатель",Orientation.Horizontal)
