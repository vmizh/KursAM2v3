...
{
    [MetadataType(typeof(DataAnnotationsTD_22ViewModel))]
    public class TD_22ViewModel : RSViewModelBase, IEntity<TD_22>
    {
        private Currency myCurrency;
        private TD_22 myEntity;

        public TD_22ViewModel()
        {
            Entity = new TD_22 {DOC_CODE = -1};
        }

        public TD_22ViewModel(TD_22 entity)
        {
        ...
        {
            if (CRS_DC > 0)
                Currency = MainReferences.Currencies[CRS_DC];
        }
    ...
    public class DataAnnotationsTD_22ViewModel : DataAnnotationForFluentApiBase,
        IMetadataProvider<TD_22ViewModel>
    {
        void IMetadataProvider<TD_22ViewModel>.BuildMetadata(
            MetadataBuilder<TD_22ViewModel> builder)
        {
            ...
            builder.Property(_ => _.SUMMA_START).AutoGenerated().DisplayName("Сумма").DisplayFormatString("n2");
            builder.Property(_ => _.CurrencyList).AutoGenerated();
        }
    }
}