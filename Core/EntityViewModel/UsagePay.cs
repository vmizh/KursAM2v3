...
namespace Core.EntityViewModel
{
    ...
    public class UsagePay : RSViewModelBase, IEntity<SD_179>
    {
    ...
    public class UsagePay_FluentAPI : DataAnnotationForFluentApiBase, IMetadataProvider<UsagePay>
    {
        void IMetadataProvider<UsagePay>.BuildMetadata(
            MetadataBuilder<UsagePay> builder)
        {
