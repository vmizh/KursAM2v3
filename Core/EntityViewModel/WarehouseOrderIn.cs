...
namespace Core.EntityViewModel
{
    ...
    public class WarehouseOrderIn : SD_24ViewModel
    {
        ...
        {
            return
                $"Приходный складкой ордер №{DD_IN_NUM}/{DD_EXT_NUM} от {DD_DATE} отправит.:{Sender} склад:{WarehouseIn}";
        }
    }
        ...
        IMetadataProvider<WarehouseOrderIn>
    {
            ...
            MetadataBuilder<WarehouseOrderIn> builder)
        {
            ...
            builder.Property(_ => _.DD_SCHET).AutoGenerated().DisplayName("Счет");
