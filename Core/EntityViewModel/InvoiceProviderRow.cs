...
namespace Core.EntityViewModel
{
    ...
    public class InvoiceProviderRow : RSViewModelBase, IEntity<TD_26>
    {
        ...
        public InvoiceProviderRow(TD_26 entity)
        {
        ...
        public bool IsUsluga => (bool) Nomenkl?.IsUsluga;
        public bool IsNaklad => (bool) Nomenkl?.IsNaklRashod;
        ...
        public void Calc()
        {
            if (IsIncludeInPrice)
            {
                Entity.SFT_SUMMA_K_OPLATE = SFT_ED_CENA * SFT_KOL;
                Entity.SFT_SUMMA_NDS = SFT_SUMMA_K_OPLATE / (1 + SFT_NDS_PERCENT);
            }
            else
            {
        ...
        IMetadataProvider<InvoiceProviderRow>
    {
            ...
            MetadataBuilder<InvoiceProviderRow> builder)
        {
            ...
            builder.Property(_ => _.SFT_SUMMA_NDS).AutoGenerated().DisplayName("НДС сумма").ReadOnly().DisplayFormatString("n2");
