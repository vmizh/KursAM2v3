...
namespace Core.EntityViewModel.AccruedAmount
{
        ...
        IMetadataProvider<AccruedAmountOfSupplierRowViewModel>
    {
            ...
            MetadataBuilder<AccruedAmountOfSupplierRowViewModel> builder)
        {
            ...
            //builder.Property(_ => _.CashDoc).NotAutoGenerated().DisplayName("Расходный касс.ордер");
            //builder.Property(_ => _.BankDoc).NotAutoGenerated().DisplayName("Банковская транзакция");
