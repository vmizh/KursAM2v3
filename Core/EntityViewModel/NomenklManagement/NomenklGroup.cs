...
namespace Core.EntityViewModel.NomenklManagement
{
    ...
    public class NomenklGroup : RSViewModelBase, IEntity<SD_82>
    {
    ...
    public class DataAnnotationsSD_82ViewModel : DataAnnotationForFluentApiBase, IMetadataProvider<NomenklGroup>
    {
        void IMetadataProvider<NomenklGroup>.BuildMetadata(MetadataBuilder<NomenklGroup> builder)
        {
