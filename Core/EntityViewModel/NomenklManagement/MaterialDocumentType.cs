...
{
    /// <summary>
    ///     Тип документа по товарным операциям SD_201
    /// </summary>
    public sealed class MaterialDocumentType : RSViewModelBase, IEntity<SD_201>
    {
        ...
        public SD_201 Load(decimal dc)
        {
            throw new NotImplementedException();
        }

        public SD_201 Load(Guid id)
        {
            throw new NotImplementedException();
        }

        public void Save(SD_201 doc)
        {
            throw new NotImplementedException();
        }
