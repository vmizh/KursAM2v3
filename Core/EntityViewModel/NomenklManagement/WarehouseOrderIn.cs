...
namespace Core.EntityViewModel.NomenklManagement
{
    ...
    public class WarehouseOrderIn : SD_24ViewModel
    {
        ...
        public override string Description =>
            $"Приходный складской ордер №{DD_IN_NUM}/{DD_EXT_NUM} от {DD_DATE.ToShortDateString()} " +
        ...
        {
            return
                $"Приходный складcкой ордер №{DD_IN_NUM}/{DD_EXT_NUM} от {DD_DATE} отправит.:{Sender} склад:{WarehouseIn}";
        }
    }
