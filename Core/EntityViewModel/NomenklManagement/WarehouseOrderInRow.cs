...
namespace Core.EntityViewModel.NomenklManagement
{
        ...
        IMetadataProvider<WarehouseOrderInRow>
    {
            ...
            MetadataBuilder<WarehouseOrderInRow> builder)
        {
            ...
            builder.Property(_ => _.LinkInvoice).AutoGenerated().NotAutoGenerated().DisplayName("Связанный с/ф");
            builder.Property(_ => _.LinkOrder).AutoGenerated().DisplayName("Связанный ордер");
            builder.Property(_ => _.Document).AutoGenerated().DisplayName("Приходный ордер");
