...
namespace Core.EntityViewModel
{
    ...
    public class WarehouseOrderInRow : TD_24ViewModel
    {
        ...
        public override string Name
        {
            get
            {
                if (Parent is WarehouseOrderOut p)
                    return $"Расходный складской ордер {p.DD_IN_NUM}/{p.DD_EXT_NUM} от {p.DD_DATE} {p.Note}";
                return null;
            }
        }
    }
        ...
        IMetadataProvider<WarehouseOrderInRow>
    {
            ...
            MetadataBuilder<WarehouseOrderInRow> builder)
        {
            ...
            builder.Property(_ => _.LinkOrder).AutoGenerated().DisplayName("Ордер");
