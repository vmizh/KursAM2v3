...
namespace KursRepositories.Repositories.Projects
{
    public interface IProjectRepository
    {
        ...
        IEnumerable<TD_84> GetUslagaClientForProject(Guid projectId, DateTime dateStart, DateTime dateEnd);
        IEnumerable<TD_26> GetUslagaProviderForProject(Guid projectId, DateTime dateStart, DateTime dateEnd);
        ...
        decimal? GetInvoiceProviderDC(Guid rowId);
