...
namespace AlfaMediaData
{
    ...
    public partial class V_SD_33
    {
        ...
        public Nullable<double> POS_PRIHOD { get; set; }
        ...
        public Nullable<double> SUM_NDS { get; set; }
        public Nullable<double> SFACT_OPLACHENO { get; set; }
