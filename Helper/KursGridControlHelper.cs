...
namespace Helper
{
    public class KursGridControlHelper
    {
        ...
        public static GridSummaryItem GetSummaryForField(GridControl grid, string fieldname)
        {
            foreach (var s in grid.TotalSummary)
            {
                if(s .FieldName == fieldname) return s;
            }
            return null;
        }

        public static GridColumn GetColumnForField(GridControl grid, string fieldname)
        {
            foreach (var s in grid.Columns)
            {
                if(s .FieldName == fieldname) return s;
            }
            return null;
