                ...
                else
                {
                    if (isAccepted)
                        data = ctx.SD_26
                            ...
                            .Where(_ => _.SF_POSTAV_DATE >= dateStart && _.SF_POSTAV_DATE <= dateEnd
                                                                      && _.SF_ACCEPTED == 1 &&
                                                                      (_.SF_CRS_SUMMA.ToString().Contains(searchText)
                                                                       ...
                                                                       || _.TD_26.Any(t =>
                                                                           t.SFT_TEXT.Contains(searchText))
                                                                       || _.TD_26.Any(t =>
                                                                           t.SFT_ED_CENA.ToString()
                                                                               .Contains(searchText))
                                                                       || _.TD_26.Any(t =>
                                                                           t.SFT_KOL.ToString().Contains(searchText))
                                                                       || _.TD_26.Any(t =>
                                                                           t.SFT_STRANA_PROIS.Contains(searchText))
                                                                       || _.TD_26.Any(t =>
                                                                           t.SFT_N_GRUZ_DECLAR.Contains(searchText))
                                                                       || _.TD_26.Any(t =>
                                                                           t.SD_83.NOM_NOMENKL.Contains(searchText))
                                                                       || _.TD_26.Any(t =>
                                                                           t.SD_83.NOM_NAME.Contains(searchText))
                                                                       || _.TD_26.Any(t =>
                                                                           t.SD_83.NOM_NOTES.Contains(searchText))
                                                                       || _.TD_26.Any(t =>
                                                                           t.SD_175.ED_IZM_NAME.Contains(searchText))
                                                                       || _.TD_26.Any(t =>
                                                                           t.SD_43.NAME.Contains(searchText))))
                            .ToList();
                    else
                        data = ctx.SD_26
                            .Include(_ => _.TD_26)
