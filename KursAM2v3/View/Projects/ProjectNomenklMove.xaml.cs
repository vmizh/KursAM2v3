...
public partial class ProjectNomenklMove : ThemedWindow
{
    ...
    {
        InitializeComponent();
        tableViewDocumentRows.AddHandler(ScrollViewer.ScrollChangedEvent, new ScrollChangedEventHandler(ScrollChanged));
    }

    private void NomenklRowsBandLeftFixedClick(object sender, RoutedEventArgs e)
    {
        var currentBand = gridNomenklRows.CurrentColumn?.ParentBand;
        if (currentBand == null) return;
        currentBand.Fixed = FixedStyle.Left;
    }

    private void NomenklRowsBandRightFixedClick(object sender, RoutedEventArgs e)
    {
        var currentBand = gridNomenklRows.CurrentColumn?.ParentBand;
        if (currentBand == null) return;
    ...
    private void NomenklRowsNoneFixedClick(object sender, RoutedEventArgs e)
    {
        var currentBand = gridNomenklRows.CurrentColumn?.ParentBand;
        if (currentBand == null) return;
    ...
    private void DocumentRowsBandLeftFixedClick(object sender, RoutedEventArgs e)
    {
        var currentBand = gridDocumentsRows.CurrentColumn?.ParentBand;
        if (currentBand == null) return;
        currentBand.Fixed = FixedStyle.Left;
    }

    private void DocumentRowsBandRightFixedClick(object sender, RoutedEventArgs e)
    {
        var currentBand = gridDocumentsRows.CurrentColumn?.ParentBand;
        if (currentBand == null) return;
        currentBand.Fixed = FixedStyle.Right;
    ...
    private void DocumentRowsNoneFixedClick(object sender, RoutedEventArgs e)
    {
        var currentBand = gridDocumentsRows.CurrentColumn?.ParentBand;
        if (currentBand == null) return;
        currentBand.Fixed = FixedStyle.None;
