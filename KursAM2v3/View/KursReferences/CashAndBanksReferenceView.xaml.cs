...
namespace KursAM2.View.KursReferences
{
    ...
    /// </summary>
    public partial class CashAndBanksReferenceView
    {
            ...
            if (grp.Name == "mainLayoutControl5")
            {
                ...
                try
                {
                    using (var ctx = GlobalOptions.GetEntities())
                    {
                        ...
                        var banks = ctx.SD_114.Include(_ => _.SD_44).ToList();
                        ...
                        foreach (var b in banks)
                            dtx.BankCash.Add(new BankCashItem
                            {
                                DocCode = b.DOC_CODE,
                                TypeItem = "Банк",
                                Name = $"{b.BA_ACC_SHORTNAME} {b.SD_44.BANK_NICKNAME} {b.BA_RASH_ACC}"
                            });
                    }
                }
                catch (Exception ex)
