...
namespace KursAM2.View.Finance.Invoices
{
    ...
    public partial class InvoiceClientView 
    {
        ...
        //public LayoutManagerGridAutoGenerationColumns LayoutGroup { get; set; }
        ...
        //    LayoutGroup = new LayoutManagerGridAutoGenerationColumns(GetType().Name, dataLayoutControl);
        //    LayoutManager.Load();
        //    var gl = LayoutGroup.Load(); 
        //    dataLayoutControl.Height = gl.Height;
        //}
        ...
        private void LayoutItems_OnAutoGeneratingItem(object sender, DataLayoutControlAutoGeneratingItemEventArgs e)
        {
            ...
            {
                case nameof(InvoiceClient.DocDate):
                    e.Item.HorizontalAlignment = HorizontalAlignment.Left;
                    break;
                case nameof(InvoiceClient.Summa):
                ...
                case nameof(InvoiceClient.SF_DILER_SUMMA):
                    ...
                    break;
                case nameof(InvoiceClient.OuterNumber):
                    ...
                    e.Item.HorizontalAlignment = HorizontalAlignment.Left;
                    break;
                case nameof(InvoiceClient.InnerNumber):
                    e.Item.IsReadOnly = true;
                    e.Item.HorizontalAlignment = HorizontalAlignment.Left;
                    break;
