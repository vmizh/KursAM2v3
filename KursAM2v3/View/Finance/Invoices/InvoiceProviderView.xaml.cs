...
namespace KursAM2.View.Finance.Invoices
{
    ...
    {
        private LayoutManagerGridAutoGenerationColumns gridFactsLayout;
        private LayoutManagerGridAutoGenerationColumns gridRowsLayout;
        private LayoutManagerGridAutoGenerationColumns gridPaysLayout;

        public ButtonEdit KontrSelectButton;
        public PopupCalcEdit PaySummaEditor;
        private WindowManager wManager = new WindowManager();
        ...
        private void Nomenkl_DefaultButtonClick(object sender, RoutedEventArgs e)
        {
            ...
            {
                defaultNDS = Convert.ToDecimal(entctx.PROFILE.FirstOrDefault(_ => _.SECTION == "НОМЕНКЛАТУРА" && _.ITEM == "НДС")?.ITEM_VALUE);
            }
        ...
        {
            //gridRowsLayout = new LayoutManagerGridAutoGenerationColumns(GetType().Name, gridRows);
            LayoutManager.RegistrControlLayouts(gridRowsLayout);
        ...
        private void GridFacts_OnAutoGeneratingColumn(object sender, AutoGeneratingColumnEventArgs e)
        {
            //e.Column.Name = e.Column.FieldName;
            //e.Column.ReadOnly = true;
            //if (KursGridPays_OnCustomSummaryFieldTypeCheckDecimal(e.Column.FieldType))
            //    e.Column.EditSettings = new CalcEditSettings
            //    {
            //        DisplayFormat = "n2",
            //        Name = e.Column.FieldName + "Calc"
            ...
            gridFactsLayout = new LayoutManagerGridAutoGenerationColumns(GetType().Name, gridFacts);
            LayoutManager.RegistrControlLayouts(gridFactsLayout);
        ...
        {
            gridPaysLayout = new LayoutManagerGridAutoGenerationColumns(GetType().Name, gridPays);
            LayoutManager.RegistrControlLayouts(gridPaysLayout);
        ...
        private GridSummaryItem hasPaysTotalSummary(string fName)
        {
            ...
            {
                if (ts.FieldName == fName) return ts;
            }
            return null;
        }
        ...
        private void TableViewPay_OnCellValueChanged(object sender, CellValueChangedEventArgs e)
        {
            ...
            if (e.Column.FieldName == "Summa")
            {
                ...
                {
                    wManager.ShowWinUIMessageBox("Сумма не может быть меньше 0 и больше суммы документа",
        ...
        private void GridPays_OnCustomSummary(object sender, CustomSummaryEventArgs e)
        {
            ...
            if (e.IsTotalSummary)
            {
                ...
                {
                    e.TotalValue = Math.Round(dtx.Document.PaymentDocs.Sum(_ => _.Summa * _.Rate) /
                                              dtx.Document.PaymentDocs.Sum(_ => _.Summa), 4);
                }
            }
        }
