...
namespace KursAM2.View.Finance.AccruedAmount
{
    ...
    public partial class AccruedAmountOfSupplierView
    {
        ...
        private void GridCashRows_OnAutoGeneratedColumns(object sender, RoutedEventArgs e)
        {
            if (ViewFluentHelper.IsSummaryExists(gridCashRows, "Summa")) return;
            gridCashRows.TotalSummary.Add(new GridSummaryItem
            {
                FieldName = "Summa",
            ...
            if (ViewFluentHelper.IsSummaryExists(gridCashRows, "DocumentType")) return;
            gridCashRows.TotalSummary.Add(new GridSummaryItem
            {
        ...
        private void TableViewCashRows_OnCellValueChanged(object sender, CellValueChangedEventArgs e)
        {
            gridRows.UpdateTotalSummary();
        }
    }
