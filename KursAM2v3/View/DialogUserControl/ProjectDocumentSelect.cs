...
//        CurrentProject = new ProjectResultInfoOld();
//        WindowName = "Связь документов с проектом";
//    }

//    public ProjectDocumentSelect(ProjectResultInfoOld project) : this()
//    {
...
//    //{
//    //    get { return new Command(LoadDocuments, _ => true); }
//    //}

//    //private void LoadDocuments(object obj)
//    //{
//    //    DocumentList.Clear();
...
//                        AnotherDocConfirmedSum = d1.ConfirmedSum,
...
//                        Note = d.NOTES_ORD,
//                        Sum = d.SUMM_ORD,
//                        ConfirmedSum = (decimal)d.SUMM_ORD - d1.ConfirmedSum,
//                        AnotherDocConfirmedSum = d1.ConfirmedSum
//                    };
