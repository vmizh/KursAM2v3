                ...
                using (var ctx = GlobalOptions.GetEntities())
                {
                    ...
                    foreach (var d in data)
                    {
                        var newdoc = new ProjectDocumentSelectViewModel
                        {
                            ...
                            DocCode = d.DOC_CODE,
                            Kontragent = MainReferences.GetKontragent(d.VZT_KONTR_DC),
                ...
                using (var ctx = GlobalOptions.GetEntities())
                {
                    ...
                    foreach (var d1 in dataRasp)
                    {
                        ...
                        var newdoc = new ProjectDocumentSelectViewModel
                        {
                            ...
                            DocCode = d.DOC_CODE,
                            Kontragent = MainReferences.GetKontragent(d.VVT_KONTRAGENT),
                ...
                using (var ctx = GlobalOptions.GetEntities())
                {
                    ...
                    foreach (var d in data)
                    {
                        var newdoc = new ProjectDocumentSelectViewModel
                        {
                            ...
                            DocCode = d.DOC_CODE,
                            Kontragent = MainReferences.GetKontragent(d.SD_84.SF_CLIENT_DC),
                ...
                using (var ctx = GlobalOptions.GetEntities())
                {
                    ...
                    foreach (var d in data)
                    {
                        var newdoc = new ProjectDocumentSelectViewModel
                        {
                            ...
                            DocCode = d.DOC_CODE,
                            Kontragent = MainReferences.GetKontragent(d.SD_26.SF_POST_DC),
                ...
                using (var ctx = GlobalOptions.GetEntities())
                {
                    ...
                    foreach (var item in data)
                    {
                        ...
                        var newdoc = new ProjectDocumentSelectViewModel
                        {
                            ...
                            Kontragent = item.SF_CLIENT_DC != null
                ...
                using (var ctx = GlobalOptions.GetEntities())
                {
                    ...
                    foreach (var d1 in cashInRasp)
                    {
                        ...
                        var newdoc = new ProjectDocumentSelectViewModel
                        {
                            ...
                            DocCode = d.DOC_CODE,
                            Kontragent = d.KONTRAGENT_DC != null ? MainReferences.GetKontragent(d.KONTRAGENT_DC) : null,
                ...
                using (var ctx = GlobalOptions.GetEntities())
                {
                    ...
                    foreach (var d in data)
                    {
                        ...
                        var newdoc = new ProjectDocumentSelectViewModel
                        {
                            ...
                            Kontragent = d.SD_24.DD_KONTR_OTPR_DC != null
