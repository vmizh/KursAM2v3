...
using KursRepositories.Repositories.CashRepositories.CashOut;
...
public sealed class CashOutWindowViewModel : RSWindowViewModelBase
{
    ...
    private readonly ICashOutRepository myRepository;
    ...
    public CashOutWindowViewModel()
    {
        ...
        IsCanSaveData = false;
        myRepository = new CashOutRepository();
        ...
        using (var ctx = GlobalOptions.GetEntities())
        {
            using (var context = GlobalOptions.GetEntities())
            {
                ...
                if (Document.SPOST_DC != null)
                    myRepository.UpdateSFProvider(Document.SPOST_DC.Value);
                ...
                if (sfDC != null && Document.SPOST_DC != sfDC)
                    myRepository.UpdateSFProvider(sfDC.Value);
                //context.Database.ExecuteSqlCommand(
