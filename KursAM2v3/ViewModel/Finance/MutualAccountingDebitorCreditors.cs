    ...
    public class MutualAccountingDebitorCreditors
    {
            ...
            IMetadataProvider<MutualAccountingDebitorViewModel>
        {
                ...
                MetadataBuilder<MutualAccountingDebitorViewModel> builder)
            {
                ...
                builder.Property(_ => _.VZT_CRS_SUMMA).AutoGenerated().DisplayName("Сумма документа").DisplayFormatString("n2");
                builder.Property(_ => _.KontragentCurrency).AutoGenerated().DisplayName("Валюта");
                builder.Property(_ => _.SfClient).AutoGenerated().DisplayName("Счет фактура").ReadOnly();
            ...
            IMetadataProvider<MutualAccountingCreditorViewModel>
        {
                ...
                MetadataBuilder<MutualAccountingCreditorViewModel> builder)
            {
                ...
                builder.Property(_ => _.VZT_CRS_SUMMA).AutoGenerated().DisplayName("Сумма документа").DisplayFormatString("n2");
                builder.Property(_ => _.KontragentCurrency).AutoGenerated().DisplayName("Валюта");
                builder.Property(_ => _.SFProvider).AutoGenerated().DisplayName("Счет фактура").ReadOnly();
                builder.Property(_ => _.VZT_CRS_POGASHENO).AutoGenerated().DisplayName("Погашено").DisplayFormatString("n2");
                builder.Property(_ => _.VzaimoraschType).AutoGenerated().DisplayName("Тип продукции");
                builder.Property(_ => _.SHPZ).AutoGenerated().DisplayName("Счет дох/расх");
            }
        }
