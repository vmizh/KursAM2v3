        ...
        IMetadataProvider<BreakEvenCOrGroupViewModel>
    {
            ...
            MetadataBuilder<BreakEvenCOrGroupViewModel> builder)
        {
            ...
            builder.Property(_ => _.Naklad).AutoGenerated().DisplayName("Себе-сть накл.").LocatedAt(7).DisplayFormatString("n2")
                .ReadOnly();
            builder.Property(_ => _.CostOne).AutoGenerated().DisplayName("Себе-сть ед.").LocatedAt(15).DisplayFormatString("n2")
                .ReadOnly();
            builder.Property(_ => _.NakladOne).AutoGenerated().DisplayName("Себе-сть ед. накл.").LocatedAt(14)
            ...
            builder.Property(_ => _.CostWOReval).AutoGenerated().DisplayName("Себе-сть (факт)").LocatedAt(6)
                .DisplayFormatString("n2").ReadOnly();
            builder.Property(_ => _.CostWORevalOne).AutoGenerated().DisplayName("Себе-сть (факт) ед.").LocatedAt(13)
                .DisplayFormatString("n2").ReadOnly();
            builder.Property(_ => _.ResultWOReval).AutoGenerated().DisplayName("Результат (факт)").LocatedAt(9)
                .DisplayFormatString("n2").ReadOnly();
            builder.Property(_ => _.NomenklProfit).AutoGenerated().DisplayName("Рентабельность").LocatedAt(12)
