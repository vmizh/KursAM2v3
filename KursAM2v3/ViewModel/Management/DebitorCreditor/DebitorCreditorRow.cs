...
namespace KursAM2.ViewModel.Management.DebitorCreditor
{
    ...
    public class DebitorCreditorRow : RSViewModelBase
    {
        ...
        [DataMember] public string ResponsibleName { set; get; }
        ...
        IMetadataProvider<DebitorCreditorRow>
    {
            ...
            MetadataBuilder<DebitorCreditorRow> builder)
        {
            ...
            builder.Property(_ => _.UchetEnd).AutoGenerated().LocatedAt(9).DisplayName("Конец (уч)")
                .DisplayFormatString("n2").ReadOnly();
            builder.Property(_ => _.ResponsibleName).AutoGenerated().LocatedAt(10).DisplayName("Ответст.").ReadOnly();

            builder.Property(_ => _.IsBalans).AutoGenerated().LocatedAt(11).DisplayName("Баланс").ReadOnly();
            builder.Property(_ => _.IsSelected).AutoGenerated().LocatedAt(12).DisplayName("Выбран").ReadOnly();
        }
    }
}
