...
namespace KursAM2.ViewModel.Management
{
    ...
    {
        void IMetadataProvider<ProfitAndLossesMainRowViewModel>.BuildMetadata(
            MetadataBuilder<ProfitAndLossesMainRowViewModel> builder)
        {
            SetNotAutoGenerated(builder);
            builder.Property(_ => _.CalcType).NotAutoGenerated();
            builder.Property(_ => _.ProfitAndLossesExtendRowViewModel).NotAutoGenerated();
            ...
            builder.Property(_ => _.RecalcProfit).AutoGenerated().DisplayName("Результат").DisplayFormatString("n2")
                .ReadOnly();
            builder.Property(_ => _.RecalcLoss).AutoGenerated().DisplayName("Результат").DisplayFormatString("n2")
                .ReadOnly();
            builder.Property(_ => _.RecalcResult).AutoGenerated().DisplayName("Результат").DisplayFormatString("n2")
                .ReadOnly();
            ...
            builder.TableLayout()
                ...
                .EndGroup()
                .Group("")
                    .ContainsProperty(_ => _.RecalcProfit)
                    .ContainsProperty(_ => _.RecalcLoss)
                    .ContainsProperty(_ => _.RecalcResult)
                .EndGroup();
            // @formatter:on
        }
    }

    [MetadataType(typeof(DataAnnotationProfitAndLossesMainRowViewModel))]
