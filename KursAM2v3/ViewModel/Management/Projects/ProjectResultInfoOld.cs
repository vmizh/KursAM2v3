...
namespace KursAM2.ViewModel.Management.Projects
{
    ...
    public class ProjectResultInfoOld : ProjectViewModel, IMultyWithDilerCurrency
    {
        ...
        public ProjectResultInfoOld()
        {
        }

        public ProjectResultInfoOld(Project p)
        {
            updateProject(p);
        }
    ...
    public class DataAnnotationsProjectResultInfoViewModel : DataAnnotationForFluentApiBase,
        IMetadataProvider<ProjectResultInfoOld>
    {
        void IMetadataProvider<ProjectResultInfoOld>.BuildMetadata(MetadataBuilder<ProjectResultInfoOld> builder)
        {
