            ...
            using (var ent = GlobalOptions.GetEntities())
            {
                ...
                if (kontr.START_BALANS != null && kontr.START_BALANS >= start && kontr.START_BALANS <= end)
                    operations.Add(new KONTR_BALANS_OPER_ARC
                    {
                        ...
                        DOC_ROW_CODE = 0,
                        KONTR_DC = kontrDC,
                        DOC_TYPE_CODE = (int) DocumentType.None,
                        CRS_OPER_IN = 0,
                        CRS_OPER_OUT = 0,
                ...
                foreach (var op in ent.TD_101.Include(_ => _.SD_101)
                    ...
                    operations.Add(new KONTR_BALANS_OPER_ARC
                    {
                        ...
                        KONTR_DC = kontrDC,
                        DOC_TYPE_CODE = (int) DocumentType.Bank,
                ...
                foreach (var op in ent.SD_33.Where(
                    ...
                    if (op != null)
                        operations.Add(new KONTR_BALANS_OPER_ARC
                        {
                            ...
                            DOC_ROW_CODE = 0,
                            KONTR_DC = kontrDC,
                            DOC_TYPE_CODE = (int) DocumentType.CashIn,
                ...
                foreach (var op in ent.SD_34.Where(
                    ...
                    operations.Add(new KONTR_BALANS_OPER_ARC
                    {
                        ...
                        DOC_ROW_CODE = 0,
                        KONTR_DC = kontrDC,
                        DOC_TYPE_CODE = (int) DocumentType.CashOut,
                        CRS_OPER_IN = 0,
                ...
                var res = from td24 in ent.TD_24
                    ...
                    select new
                    {
                        ...
                        KONTR_DC = kontrDC,
                        DOC_TYPE_CODE = (int) DocumentType.InvoiceProvider,
                ...
                var vozvratTovara = from td24 in ent.TD_24
                    ...
                    select new
                    {
                        ...
                        DOC_ROW_CODE = 0,
                        KONTR_DC = kontrDC,
                        DOC_TYPE_CODE = (int) DocumentType.InvoiceClient,
                ...
                var resProdNal = from sd259 in ent.SD_259
                    select new
                    {
                        ...
                        DOC_ROW_CODE = 0,
                        KONTR_DC = kontrDC,
                        DOC_TYPE_CODE = (int) DocumentType.SaleForCash,
                        CRS_OPER_IN = 0,
                ...
                var resActZachet = from sd110 in ent.SD_110
                    ...
                    select new
                    {
                        ...
                        KONTR_DC = kontrDC,
                        DOC_TYPE_CODE = (int) DocumentType.MutualAccounting,
                ...
                foreach (
                    ...
                    operations.Add(new KONTR_BALANS_OPER_ARC
                    {
                        ...
                        DOC_ROW_CODE = 0,
                        KONTR_DC = kontrDC,
                        DOC_TYPE_CODE = (int) DocumentType.ActReconciliation,
                        CRS_OPER_IN = 0,
                        CRS_OPER_OUT = 0,
                        OPER_CRS_DC = kontr.SD_301.DOC_CODE,
                        OPER_CRS_RATE = 1,
