...
namespace KursAM2.ViewModel.Management
{
    ...
    public sealed class ProfitAndLossesWindowViewModel2 : RSWindowViewModelBase
    {
        ...
        public ObservableCollection<ProfitAndLossCommonRow> CommonResult { set; get; } 
            = new ObservableCollection<ProfitAndLossCommonRow>();
        ...
        public override void UpdateVisualObjects()
        {
            ...
            foreach (var col in frm.treeListCommon.Columns)
            {
                ...
                {
                    frm.treeListCommon.TotalSummary.Add(new TreeListSummaryItem()
                    {
        ...
        private void SetOneCommonRow(ProfitAndLossCommonRow row,
            ObservableCollection<ProfitAndLossesMainRowViewModel> data)
        {
            foreach (var mainRow in data)
            {
                if (mainRow.Id != row.ProfitId && mainRow.Id != row.LossId) continue;
        ...
        IMetadataProvider<CurrencyConvertRow>
    {
            ...
            MetadataBuilder<CurrencyConvertRow> builder)
        {
            ...
            builder.Property(_ => _.Rate).LocatedAt(4).AutoGenerated().DisplayName("Курс").DisplayFormatString("n2")
                .ReadOnly();
    ...
    public class DataAnnotationAccruedDocument : DataAnnotationForFluentApiBase,
        IMetadataProvider<AccruedDocument>
    {
        void IMetadataProvider<AccruedDocument>.BuildMetadata(
    ...
    [MetadataType(typeof(DataAnnotationAccruedDocument))]
    public class AccruedDocument : IProfitCurrencyList
    {
        public Guid? DocId { set; get; }
        public string DocNum { set; get; }
        public DateTime DocDate { set; get; }
        public string Creator { set; get; }
        public string DocName { set; get; }
        public string Currency => ((IName)Kontragent?.Currency)?.Name;
