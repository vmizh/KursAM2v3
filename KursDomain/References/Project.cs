...
public class Project : IProject, IDocGuid, IName, IEquatable<Project>, IComparable, ICache
{
    ...
    [Display(AutoGenerateField = true,Name = "Искл. из приб/убыт")]
    ...
    public void LoadFromEntity(Projects entity, IReferencesCache refCache)
    {
        ...
        IsExcludeFromProfitAndLoss = entity.IsExcludeFromProfitAndLoss ?? false;
    }
...
public class ProjectViewModel : RSViewModelBase, IEntity<Projects>
{
    ...
    public bool IsExcludeFromProfitAndLoss
    {
        get => Entity.IsExcludeFromProfitAndLoss ?? false;
        set
        {
            if (Entity.IsExcludeFromProfitAndLoss == value) return;
            Entity.IsExcludeFromProfitAndLoss = value;
            RaisePropertyChanged();
        }
    }
    ...
    public void UpdateFrom(Projects ent)
    {
        ...
        IsExcludeFromProfitAndLoss = ent.IsExcludeFromProfitAndLoss ?? false;
    ...
    public void UpdateTo(Projects ent)
    {
        ...
        ent.IsExcludeFromProfitAndLoss = IsExcludeFromProfitAndLoss;
    }
}
...
public class DataAnnotationsProjectsViewModel : DataAnnotationForFluentApiBase, IMetadataProvider<ProjectViewModel>
{
    void IMetadataProvider<ProjectViewModel>.BuildMetadata(MetadataBuilder<ProjectViewModel> builder)
    {
        ...
        builder.Property(_ => _.IsExcludeFromProfitAndLoss).DisplayName("Искл. из приб/убыт");
