...
public class DataAnnotationsPERIOD_GROUPSViewModel : DataAnnotationForFluentApiBase,
    IMetadataProvider<PERIOD_GROUPSViewModel>
{
    void IMetadataProvider<PERIOD_GROUPSViewModel>.BuildMetadata(MetadataBuilder<PERIOD_GROUPSViewModel> builder)
    {
        SetNotAutoGenerated(builder);
        builder.Property(_ => _.Name).AutoGenerated().DisplayName("Группы пользователей");
    }
}
