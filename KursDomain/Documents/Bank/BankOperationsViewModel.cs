...
public sealed class BankOperationsViewModel : RSViewModelBase, IEntity<TD_101>
{
    ...
    public override string Description
    {
        get
        {
            var operType = VVT_VAL_PRIHOD > 0 ? "приход от" : "расход для";
            return
    ...
    public decimal CurrencyRateForReference
    {
        get => Entity.CurrencyRateForReference ?? 1;
        set
        {
            if (Entity.CurrencyRateForReference == value) return;
            Entity.CurrencyRateForReference = value;
            RaisePropertyChanged();
        }
    }
    ...
    public References.Currency Currency
    {
        ...
        set
        {
            ...
            myCurrency = value;
            if (myCurrency != null)
                Entity.VVT_CRS_DC = myCurrency.DocCode;
            RaisePropertyChanged();
        }
    }
    ...
    public References.Employee Employee
    {
        ...
        set
        {
            ...
            myEmployee = value;
            if (myEmployee != null)
                Entity.EmployeeDC = myEmployee.DocCode;
            RaisePropertyChanged();
    ...
    IMetadataProvider<BankOperationsViewModel>
{
    void IMetadataProvider<BankOperationsViewModel>.BuildMetadata(MetadataBuilder<BankOperationsViewModel> builder)
    {
        ...
        builder.Property(_ => _.CurrencyRateForReference).AutoGenerated().DisplayName("Курс(справочно)")
