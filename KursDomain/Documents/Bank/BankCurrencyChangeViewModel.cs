...
public sealed class BankCurrencyChangeViewModel : RSViewModelBase, IEntity<BankCurrencyChange>
{
    ...
    private References.Currency myCurrencyFrom;
    private References.Currency myCurrencyTo;
    ...
    public References.Currency CurrencyFrom
    {
        get => myCurrencyFrom;
        set
        {
    ...
    public References.Currency CurrencyTo
    {
        get => myCurrencyTo;
        set
        {
