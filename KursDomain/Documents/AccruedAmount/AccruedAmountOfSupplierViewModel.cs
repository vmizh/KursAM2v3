...
public class AccruedAmountOfSupplierViewModel : RSViewModelBase, IDataErrorInfo
{
    ...
    private CentrResponsibility myCentrResponsibility;
    ...
    {
        get => myKontragent; //GlobalOptions.ReferencesCache.GetKontragent(Entity.KontrDC) as Kontragent;
        set
        {
    ...
    {
        get => myCentrResponsibility; // 
        set
        {
            if (myCentrResponsibility == value) return;
            if (value != null)
            {
                Entity.CentrResponsibleDC = value.DocCode;
                myCentrResponsibility =
                    GlobalOptions.ReferencesCache.GetCentrResponsibility(Entity.CentrResponsibleDC) as
                        CentrResponsibility;
                RaisePropertyChanged();
                RaisePropertyChanged(nameof(Currency));
            }
    ...
    public AccruedAmountOfSupplierViewModel(AccruedAmountOfSupplier entity, ALFAMEDIAEntities context)
    {
        ...
        if (Entity.KontrDC != 0)
            Kontragent = GlobalOptions.ReferencesCache.GetKontragent(Entity.KontrDC) as Kontragent;
