...
namespace KursDomain.Documents.Cash
{
    ...
    public class CashOut : RSViewModelBase, IEntity<SD_34>
    {
        ...
        private KursDomain.Documents.Cash.Cash myCash;
        private KursDomain.Documents.Cash.Cash myCashTo;
        private Currency myCurrency;
        private Core.EntityViewModel.Employee.Employee myEmployee;
        ...
        public Core.EntityViewModel.Employee.Employee Employee
        {
            get => myEmployee;
            set
            {
        ...
        public KursDomain.Documents.Cash.Cash Cash
        {
            get => myCash;
            set
            {
            ...
            get
            {
                return KontragentType switch
                {
                    ...
                    CashKontragentType.Kontragent => KONTRAGENT_DC != null
                        ...
                        : null,
                    CashKontragentType.Cash => CASH_TO_DC != null ? CashTo.CA_NAME : null,
        ...
        public KursDomain.Documents.Cash.Cash CashTo
        {
            get => myCashTo;
            set
            {
        ...
        private void LoadReferences()
        {
            ...
            if (CASH_TO_DC != null)
            {
                ...
                CashTo = MainReferences.Cashs[CASH_TO_DC.Value];
            }
