...
public class WarehouseOrderOutRow : TD_24ViewModel
{
    ...
    private WarehouseOrderInRow myOrderInRow;
    ...
    public WarehouseOrderInRow OrderInRow
    {
        get => myOrderInRow;
        set
        {
            if (Equals(value, myOrderInRow)) return;
            myOrderInRow = value;
            RaisePropertyChanged();
        }
    }
    ...
    IMetadataProvider<WarehouseOrderOutRow>
{
        ...
        MetadataBuilder<WarehouseOrderOutRow> builder)
    {
        ...
        builder.Property(_ => _.OrderInRow).AutoGenerated().DisplayName("Связанный док-т").ReadOnly();
