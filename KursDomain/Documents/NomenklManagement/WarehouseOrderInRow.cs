    ...
    IMetadataProvider<WarehouseOrderInRow>
{
        ...
        MetadataBuilder<WarehouseOrderInRow> builder)
    {
        ...
        builder.Property(_ => _.LinkInvoice).NotAutoGenerated().DisplayName("Связанный с/ф");
        builder.Property(_ => _.LinkOrder).NotAutoGenerated().DisplayName("Связанный ордер");
        ...
        builder.Property(_ => _.DocInNum).AutoGenerated().LocatedAt(1).DisplayName("Внутр.№").ReadOnly();
        builder.Property(_ => _.DocExtNum).AutoGenerated().LocatedAt(2).DisplayName("Внешн.№").ReadOnly();
        builder.Property(_ => _.DocDate).AutoGenerated().LocatedAt(3).DisplayName("Дата").ReadOnly();
        ...
        builder.Property(_ => _.SDRSchet).AutoGenerated().LocatedAt(9).DisplayName("Счет дох./расх.").ReadOnly();
    }
}
