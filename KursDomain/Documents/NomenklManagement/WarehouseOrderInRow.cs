    ...
    IMetadataProvider<WarehouseOrderInRow>
{
        ...
        MetadataBuilder<WarehouseOrderInRow> builder)
    {
        ...
        builder.Property(_ => _.DDT_KOL_PRIHOD).AutoGenerated().LocatedAt(7).DisplayName("Кол-во").DisplayFormatString("n2");
        builder.Property(_ => _.Unit).AutoGenerated().LocatedAt(8).DisplayName("Ед.изм").ReadOnly();
        builder.Property(_ => _.LinkInvoice).LocatedAt(9).NotAutoGenerated().DisplayName("Связанный с/ф").ReadOnly();
        builder.Property(_ => _.LinkOrder).NotAutoGenerated().LocatedAt(10).DisplayName("Связанный ордер").ReadOnly();
        builder.Property(_ => _.LinkDocument).AutoGenerated().LocatedAt(12).DisplayName("Связанный документ").ReadOnly();
        builder.Property(_ => _.SDRSchet).AutoGenerated().LocatedAt(11).DisplayName("Счет дох./расх.");
        builder.Property(_ => _.Note).AutoGenerated().LocatedAt(13).DisplayName("Примечание");
