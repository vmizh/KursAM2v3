    ...
    IMetadataProvider<WarehouseOrderInRow>
{
        ...
        MetadataBuilder<WarehouseOrderInRow> builder)
    {
        ...
        builder.Property(_ => _.LinkInvoice).LocatedAt(9).NotAutoGenerated().DisplayName("Связанный с/ф");
        builder.Property(_ => _.LinkOrder).NotAutoGenerated().LocatedAt(10).DisplayName("Связанный ордер");
        builder.Property(_ => _.LinkDocument).AutoGenerated().LocatedAt(12).DisplayName("Связанный документ");
