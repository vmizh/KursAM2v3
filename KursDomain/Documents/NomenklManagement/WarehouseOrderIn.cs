    ...
    IMetadataProvider<WarehouseOrderIn>
{
        ...
        MetadataBuilder<WarehouseOrderIn> builder)
    {
        ...
        builder.Property(_ => _.LastChanger).AutoGenerated().DisplayName("Посл. изменивший");
        builder.Property(_ => _.LastChangerDate).AutoGenerated().DisplayName("Дата посл.изм.");
