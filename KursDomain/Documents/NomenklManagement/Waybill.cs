...
public class WaybillShort_FluentAPI : DataAnnotationForFluentApiBase, IMetadataProvider<WayBillShort>
{
        ...
        MetadataBuilder<WayBillShort> builder)
    {
        ...
        builder.Property(x => x.Project).AutoGenerated().DisplayName("Проект").LocatedAt(5);
        builder.Property(x => x.Note).AutoGenerated().DisplayName("Примечания").LocatedAt(6);
        builder.Property(x => x.DD_KOMU_PEREDANO).AutoGenerated().DisplayName("Через кого").LocatedAt(7);
        builder.Property(x => x.LastChanger).AutoGenerated().DisplayName("Посл.изменил").LocatedAt(8);
        builder.Property(x => x.LastChangerDate).AutoGenerated().DisplayName("Дата посл.изм.").LocatedAt(9);
...
public class WayBillShort : RSViewModelBase, IEntity<SD_24>
{
    ...
    public Project Project => GlobalOptions.ReferencesCache.GetProject(Entity.ProjectId) as Project;
...
public class Waybill : SD_24ViewModel, IDocument<Waybill>
{
    ...
    public Waybill(SD_24 entity) : base(entity)
    {
        ...
        if (InvoiceClientViewModel is not null)
            KontragentViewModelReceiver = InvoiceClientViewModel.Client;
...
public class Waybill_FluentAPI : DataAnnotationForFluentApiBase, IMetadataProvider<Waybill>
{
        ...
        MetadataBuilder<Waybill> builder)
    {
        ...
        builder.Property(x => x.Project).AutoGenerated().DisplayName("Проект");
