...
public class WaybillShort_FluentAPI : DataAnnotationForFluentApiBase, IMetadataProvider<WayBillShort>
{
        ...
        MetadataBuilder<WayBillShort> builder)
    {
        ...
        builder.Property(x => x.LastChanger).AutoGenerated().DisplayName("Посл.изменил").LocatedAt(7);
        builder.Property(x => x.LastChangerDate).AutoGenerated().DisplayName("Дата посл.изм.").LocatedAt(8);
    }
}
