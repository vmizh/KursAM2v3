...
{
    private References.Currency myCreditorCurrency;
    ...
    public References.Currency DebitorCurrency
    {
    ...
    public References.Currency CreditorCurrency
    {
...
public static class DataAnnotationsSD_110ViewModel
{
    public static void BuildMetadata(MetadataBuilder<SD_110ViewModel> builder)
    {
        ...
        builder.Property(_ => _.VZ_PRIBIL_UCH_CRS_SUM).DisplayName("Результат").DisplayFormatString("n2");
        ...
        builder.Property(_ => _.LastChanger).DisplayName("Посл.изменил");
        builder.Property(_ => _.LastChangerDate).DisplayName("дата посл.изменения");
    }
}
