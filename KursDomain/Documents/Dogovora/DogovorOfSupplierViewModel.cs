    ...
    IMetadataProvider<DogovorOfSupplierViewModel>
{
        ...
        MetadataBuilder<DogovorOfSupplierViewModel> builder)
    {
        ...
        builder.Property(_ => _.Kontragent).AutoGenerated().DisplayName("Поставщик")
...
public class DogovorOfSupplierViewModel : RSWindowViewModelBase, IDataErrorInfo, IEntity<DogovorOfSupplier>
{
    ...
    {
        get => Entity.KontrDC != 0 ? GlobalOptions.ReferencesCache.GetKontragent(Entity.KontrDC) as Kontragent : null;
        set
        {
    ...
    public string this[string columnName]
    {
        get
        {
            switch (columnName)
            {
                case nameof(KontragentViewModel):
