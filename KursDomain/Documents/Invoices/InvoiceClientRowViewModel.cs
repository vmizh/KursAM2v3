    ...
    IMetadataProvider<InvoiceClientRowViewModel>
{
    void IMetadataProvider<InvoiceClientRowViewModel>.BuildMetadata(MetadataBuilder<InvoiceClientRowViewModel> builder)
    {
        ...
        builder.Property(_ => _.Shipped).AutoGenerated().DisplayName("Отгружено").DisplayFormatString("n4").ReadOnly();
        builder.Property(_ => _.Rest).AutoGenerated().DisplayName("Остаток").DisplayFormatString("n4").ReadOnly();
