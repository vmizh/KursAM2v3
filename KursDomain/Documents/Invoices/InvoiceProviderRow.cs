...
namespace Core.EntityViewModel.Invoices
{
    public interface IInvoiceProviderRow
    {
        ...
        string Note { set; get; }
        [Display(AutoGenerateField = false)]
        Unit PostUnit { set; get; }
        [Display(AutoGenerateField = false)]
        Unit UchUnit { set; get; }
        [Display(AutoGenerateField = false)]
        decimal SFT_POST_KOL { set; get; }
        ...
        [Display(AutoGenerateField = false)]
        decimal? SFT_SUMMA_K_OPLATE { set; get; }
        ...
        bool IsNaklad { get; }
        [Display(AutoGenerateField = false)]
        bool IsIncludeInPrice { set; get; }
        [Display(AutoGenerateField = false)]
        decimal? SFT_SUMMA_K_OPLATE_KONTR_CRS { set; get; }
    ...
    public class InvoiceProviderRow : RSViewModelBase, IEntity<TD_26>, IInvoiceProviderRow
    {
        ...
        public Nomenkl Nomenkl
        {
            ...
            set
            {
                ...
                if (myNomenkl != null)
                {
                    ...
                    Entity.SFT_POST_ED_IZM_DC = myNomenkl.Unit.DocCode;
                    Entity.SFT_UCHET_ED_IZM_DC = myNomenkl.Unit.DocCode;
                }
        ...
        {
            set { }
            get { return Nomenkl?.NomenklNumber; }
        }
