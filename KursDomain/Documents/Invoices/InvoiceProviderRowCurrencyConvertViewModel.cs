    ...
    IMetadataProvider<InvoiceProviderRowCurrencyConvertViewModel>
{
        ...
        MetadataBuilder<InvoiceProviderRowCurrencyConvertViewModel> builder)
    {
        ...
        builder.Property(_ => _.NomenklFrom).NotAutoGenerated();
        builder.Property(_ => _.NomenklTo).NotAutoGenerated();
        builder.Property(_ => _.InvoiceProviderRow).NotAutoGenerated();
        builder.Property(_ => _.Warehouse).NotAutoGenerated();
        ...
        builder.Property(_ => _.Store).AutoGenerated().DisplayName("Склад").LocatedAt(4);
        builder.Property(_ => _.State).NotAutoGenerated();
        builder.Property(_ => _.NomenklId).NotAutoGenerated();
        builder.Property(_ => _.NomenkNumber).AutoGenerated().DisplayName("Ном.№").LocatedAt(2);
        builder.Property(_ => _.Nomenkl).AutoGenerated().DisplayName("Номенклатура").ReadOnly().LocatedAt(3);
        builder.Property(_ => _.Currency).AutoGenerated().DisplayName("Валюта").ReadOnly().LocatedAt(5);
        builder.Property(_ => _.Quantity).AutoGenerated().DisplayName("Кол-во").DisplayFormatString("n1").LocatedAt(6);
        builder.Property(_ => _.Rate).AutoGenerated().DisplayName("Курс").DisplayFormatString("n4").LocatedAt(9);
        builder.Property(_ => _.Date).AutoGenerated().DisplayName("Дата").LocatedAt(1);
        builder.Property(_ => _.Price).AutoGenerated().DisplayName("Цена").DisplayFormatString("n2").LocatedAt(7);
        builder.Property(_ => _.PriceWithNaklad).AutoGenerated().DisplayName("Цена(накл)").LocatedAt(10)
            .DisplayFormatString("n2");
        builder.Property(_ => _.Summa).AutoGenerated().DisplayName("Сумма").DisplayFormatString("n2").ReadOnly().LocatedAt(8);
        builder.Property(_ => _.SummaWithNaklad).AutoGenerated().DisplayName("Сумма(накл)").DisplayFormatString("n2")
            .ReadOnly().LocatedAt(11);
        builder.Property(_ => _.Note).AutoGenerated().DisplayName("Примечание").LocatedAt(12);
    }
}
